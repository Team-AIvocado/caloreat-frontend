...
export const PhysicalInfoSection = ({ initialData }) => {
    ...
    const handleUpdate = async () => {
        try {
            await updatePhysicalInfo(height, weight, initialData.gender, initialData.birthdate);
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-sm mb-4 border border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1">키 (cm)</label>
                    <input
                        type="number"
                        value={height}
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-600 mb-1">몸무게 (kg)</label>
                    <input
                        type="number"
                        value={weight}
