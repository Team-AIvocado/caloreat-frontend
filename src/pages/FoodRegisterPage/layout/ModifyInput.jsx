...
export const ModifyInput = ({ initialFoodText, setFoodText, closeAlert }) => {
  const [localUserInput, setLocalUserInput] = useState(initialFoodText);

  const handleSave = () => {
    setFoodText(localUserInput);
  };
