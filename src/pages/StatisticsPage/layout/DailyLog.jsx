export const DailyLog = ({ logs }) => {
  ...
  if (!logs || logs.length === 0) {
    return (
      <div className="bg-white rounded-lg p-5 border border-sub_border w-full mt-4 text-center text-secondary_text">
        기록된 식단이 없습니다.
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg p-5 border-3 border-sub_border w-full mt-4">
